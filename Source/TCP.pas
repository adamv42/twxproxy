...
type
  ...
  protected
    ...
    procedure tcpClientDataAvailable(Sender: TTnCnx; Buffer: PChar; Len: Integer);
...
procedure TModClient.tcpClientDataAvailable(Sender: TTnCnx; Buffer: PChar;
  Len: Integer);
var
  InString,
  XString  : string;
